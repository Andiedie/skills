...
8. `issue-implement` works from the GitHub-native Package Contract in an isolated branch or worktree and records implementation evidence.
...
11. Completion or rejection sets a lifecycle outcome and records evidence in a receipt.
