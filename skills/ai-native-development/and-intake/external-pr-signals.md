...
- Search the configured backend and the PR's references for one authoritative work record that tracks the exact requested behavior.
...
- Return the PR URL and captured evidence to the main intake process; the configured backend determines their representation.
